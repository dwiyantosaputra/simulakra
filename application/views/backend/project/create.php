        ...
        <form class="uk-form" method="post" action="<?=base_url('backend/project/add')?>">
            ...
            <div class="uk-grid uk-grid-small">
                <div class="uk-width-medium-2-4 uk-push-1-4">
                    ...
                    <div class="uk-form-controls">
                        <textarea name="project_description" class="uk-width-1-1"></textarea>
                    </div>
                </div>
            </div>
            <div class="uk-grid uk-grid-small">
                    ...
                    <div class="uk-panel uk-panel-box uk-panel-box-secondary">
                        ...
                        <div class="uk-grid uk-grid-small uk-grid-match">
                            ...
                            <div class="uk-width-1-2 uk-width-medium-1-3">
                                ...
                                <input type="hidden" name="image_media_1" value="">
                            </div>
                            <!-- Media Image 2 -->
                            <div class="uk-width-1-2 uk-width-medium-1-3">
                                ...
                                <input type="hidden" name="image_media_2" value="">
                            </div>
                            <!-- Media Image 3 -->
                            <div class="uk-width-1-2 uk-width-medium-1-3">
                                ...
                                <input type="hidden" name="image_media_3" value="">
                            </div>
                            <!-- Media Image 4 -->
                            <div class="uk-width-1-2 uk-width-medium-1-3">
                                ...
                                <input type="hidden" name="image_media_4" value="">
                            </div>
                            <!-- Media Image 5 -->
                            <div class="uk-width-1-2 uk-width-medium-1-3">
                                ...
                                <input type="hidden" name="image_media_5" value="">
                            </div>
                            <!-- Media Image 6 -->
                            <div class="uk-width-1-2 uk-width-medium-1-3">
                                ...
                                <input type="hidden" name="image_media_6" value="">
                            </div>
                            <!-- Media Image 7 -->
                            <div class="uk-width-1-2 uk-width-medium-1-3">
                                ...
                                <input type="hidden" name="image_media_7" value="">
                            </div>
                            <!-- Media Image 8 -->
                            <div class="uk-width-1-2 uk-width-medium-1-3">
                                ...
                                <input type="hidden" name="image_media_8" value="">
                            </div>
                            <!-- Video URL -->
                            <div class="uk-width-1-1">
                                <label class="uk-form-label" for="project_description">Video URL</label>
                                <div class="uk-form-controls">
                                    <input id="video_url" class="uk-width-1-1" type="text" name="video_media_url" placeholder="http://" value="">
                                </div>
                            </div>
                        </div>
                    </div>
